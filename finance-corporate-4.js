...
Separation of the CEO and board chair roles is another frequently discussed governance topic — when the same individual serves as both CEO (running the company) and board chair (leading the body that oversees the CEO), some argue this concentration of power can weaken the board's ability to provide independent oversight, though companies and governance experts differ on whether combined or separate roles produce better outcomes in practice, and many companies use a "lead independent director" as a partial alternative when the CEO also chairs the board.

For accountants, understanding governance structures — particularly the audit committee's role — is directly relevant, since the audit committee is often the primary point of contact for both internal and external auditors regarding significant accounting issues, judgments, and any disagreements with management.`,
    quiz: [
      {
...
Taxes are perhaps the most significant factor. Because interest expense is tax-deductible while dividends and other returns to equity holders generally are not, debt financing creates a "tax shield" — each dollar of interest expense reduces the company's tax bill, effectively meaning the government bears part of the cost of debt financing. This creates an incentive to use more debt, all else equal, as captured in the "M&M theorem with taxes," which suggests company value increases with leverage due to this tax benefit.
...
An alternative perspective, the "pecking order theory," suggests companies don't target a specific optimal capital structure at all, but instead follow a preference ordering when financing new investments: first using internally generated funds (retained earnings), then debt, and only as a last resort issuing new equity. This ordering is explained by information asymmetry — managers know more about the company's true value and prospects than outside investors, and issuing new equity can signal to the market that managers believe the stock is overvalued (since they'd prefer to issue debt if they thought the stock was undervalued), causing the stock price to fall on the announcement of an equity issuance — a pattern frequently observed empirically.

In practice, most observers believe both trade-off and pecking-order considerations influence real-world capital structure decisions, alongside other factors like maintaining financial flexibility, signaling effects, and industry norms.`,
    quiz: [
      {
...
Translation exposure (discussed in more detail in the foreign currency translation article) arises from translating the financial statements of foreign subsidiaries into the parent's reporting currency for consolidation purposes. Unlike transaction exposure, translation exposure doesn't necessarily involve actual cash flows — it's an accounting effect. Some companies choose not to hedge translation exposure at all, on the theory that it's a "paper" effect that doesn't represent real economic cash flow risk (particularly if the foreign subsidiary's earnings are reinvested locally rather than repatriated); others hedge it using instruments like cross-currency swaps, particularly if translation effects significantly impact reported earnings in ways that concern investors or affect debt covenants tied to reported financial metrics.

Economic exposure (sometimes called operating exposure) is the broadest and most difficult to hedge — it refers to the impact of exchange rate movements on a company's competitive position and future cash flows, even absent any specific contractual transactions. For example, if a U.S. manufacturer competes with European manufacturers, and the dollar strengthens significantly against the euro, European competitors' costs become relatively cheaper in dollar terms, potentially allowing them to underprice the U.S. manufacturer — affecting the U.S. company's future sales and market share in ways that can't be hedged with a simple forward contract on a specific transaction. Managing economic exposure often involves longer-term strategic responses, such as shifting production locations, diversifying supplier bases across currencies, or adjusting pricing strategies.
...
Comparable transactions and market multiples — looking at what similar companies have recently sold for, or what multiples of revenue (rather than earnings, since many startups have no earnings) recent funding rounds or acquisitions in the same sector have been valued at — provide a market-based reference point, though "comparability" can be loose for unique or rapidly evolving business models, and multiples in hot sectors can be volatile and sentiment-driven.

The "scorecard method" and "Berkus method," more common for very early-stage (pre-revenue) companies, involve qualitative assessments across factors like the strength of the management team, size of the market opportunity, the product/technology, competitive environment, and existing partnerships, translating these qualitative assessments into a valuation estimate, often by comparing to a baseline valuation for similar companies in the region and adjusting up or down based on the startup's relative strengths and weaknesses across these factors.

Regardless of method, a defining feature of startup valuation is the wide range of plausible outcomes — unlike valuing an established company, where different reasonable methods might converge on a range of, say, plus or minus 20%, startup valuations can vary by multiples depending on assumptions about whether (and how) the company succeeds, reflecting the fundamentally binary, high-variance nature of early-stage outcomes (most startups fail entirely, while a small number generate outsized returns) — a dynamic discussed further in the context of venture capital's "power law" return distribution.`,
    quiz: [
      {
...
Commercial paper is a short-term, unsecured promissory note issued by large, creditworthy corporations, typically with maturities ranging from a few days to 270 days (a common ceiling, since longer maturities would trigger SEC registration requirements that commercial paper is designed to avoid). Commercial paper is sold at a discount to face value (similar to Treasury bills), with the investor's return coming from the difference between the discounted purchase price and face value at maturity. Because it's unsecured and relies on the issuer's general creditworthiness, commercial paper is generally only accessible to large companies with strong credit ratings — smaller or less creditworthy companies typically can't access this market on favorable terms, if at all. Companies often maintain backup lines of credit specifically to ensure they could repay maturing commercial paper even if they're temporarily unable to "roll over" (reissue) new commercial paper to replace maturing paper — a risk that became acutely relevant during the 2008 financial crisis when the commercial paper market experienced significant disruption.

A revolving credit facility ("revolver") is a flexible line of credit that a company can draw upon, repay, and redraw as needed, up to a specified limit, typically provided by a bank or syndicate of banks. Unlike a traditional term loan (which provides a fixed amount upfront, repaid according to a set schedule), a revolver functions more like a corporate credit card — the company pays interest only on amounts actually drawn, plus often a smaller "commitment fee" on the undrawn portion (compensating the lender for standing ready to lend). Revolvers are commonly used to manage seasonal working capital needs — for example, a retailer might draw on its revolver to finance inventory buildup ahead of the holiday season, then repay the balance as holiday sales generate cash.

Trade credit — the practice of suppliers allowing customers to pay for goods or services some time after delivery (reflected in accounts payable on the buyer's balance sheet and accounts receivable on the seller's) — represents one of the largest sources of short-term financing for many companies, particularly smaller businesses that may not have ready access to commercial paper or bank credit lines. Trade credit terms are often expressed as, for example, "2/10, net 30" — meaning a 2% discount is available if payment is made within 10 days, with the full amount otherwise due within 30 days. Failing to take an available early-payment discount can represent a very high implicit cost of financing — in the "2/10, net 30" example, foregoing the 2% discount to delay payment by an additional 20 days (from day 10 to day 30) represents an annualized cost of financing of roughly 36% (2% for 20 days, annualized), making early payment (or taking the discount) often financially preferable to using more expensive financing alternatives if cash is available.
...
A commonly used framework is the "Five Cs of Credit": Character (the borrower's reputation, track record, and management quality — including, for established companies, their history of meeting prior obligations), Capacity (the borrower's ability to generate sufficient cash flow to service the proposed debt, typically assessed through cash flow analysis and coverage ratios), Capital (the borrower's own equity investment in the business — lenders generally want to see that owners have meaningful "skin in the game"), Collateral (assets that could be pledged to secure the loan, providing the lender a recovery source if the borrower defaults), and Conditions (the broader economic and industry conditions affecting the borrower's business and the specific purpose and terms of the loan).
...
Beyond ratios, lenders examine cash flow projections under various scenarios (sensitivity and scenario analysis, as discussed elsewhere), the quality and liquidation value of any collateral offered, the company's position within its industry and competitive dynamics, and increasingly, environmental, social, and governance factors that might present emerging risks. For larger or more complex borrowers, lenders may also rely on third-party credit ratings (discussed in the credit risk and bond ratings article) as part of their assessment, though sophisticated lenders typically conduct their own independent analysis rather than relying solely on external ratings.

The output of credit analysis influences not just the binary lend/don't-lend decision, but also the specific terms offered — interest rate (often expressed as a spread over a reference rate, with riskier borrowers paying wider spreads), required collateral, covenant package, and loan maturity — all calibrated to the lender's assessment of the borrower's risk and the lender's required compensation for bearing that risk.`,
    quiz: [
      {
